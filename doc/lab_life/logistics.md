...
### IONS
Open a Ticket [here](https://uclouvain.atlassian.net/servicedesk/customer/portal/3/group/20/create/263) and add this info:

1. The printers: IMP-COSY-01 and IMP-COSY-02
2. The ID of the UCLouvain computer to which you are requesting access to the printers

### IPSY
Ask the local IT (Roland Jamais)
